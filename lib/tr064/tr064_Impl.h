...
void TR064::showHomeauto_Services() {
    String inStr = httpRequest("/x_homeautoSCPD.xml", "", "", _protocol);
...
void TR064::initServiceURLs() {
     ...
     */
    String inStr = httpRequest(_detectPage, "", "", _protocol);
    int CountChar = 7; //length of word "service"
    int i = 0;
    deb_println(F("Detected Services:"), DEBUG_INFO);
...
String TR064::action_raw(String service, String act, String params[][2], int nParam) {
    ...
    //RoSchmi
    deb_println("\r\nSending request to:", DEBUG_VERBOSE);
    String theService = findServiceURL(service);
    deb_println(theService, DEBUG_VERBOSE);  
    deb_println(soapaction, DEBUG_VERBOSE);

    return httpRequest(findServiceURL(service), xml, soapaction, _protocol);   
    }
/**************************************************************************/
/*!
...
*/
/**************************************************************************/
String TR064::httpRequest(String url, String xml, String soapaction, Protocol protocol) {
...
*/
/**************************************************************************/
String TR064::httpRequest(String url, String xml, String soapaction, bool retry, Protocol protocol) {
